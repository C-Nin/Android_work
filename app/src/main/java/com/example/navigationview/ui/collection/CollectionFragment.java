...
public class CollectionFragment extends Fragment {
    ...
    private CollectionFragment.MyCollectionAdapter adapter;
    //http
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        adapter=new CollectionFragment.MyCollectionAdapter();
        recyclerView.setAdapter(adapter);
        return view;
    }
    private void getData() {
        String url=new MyApplication().selectCollectionurl;
    ...
    class  MyCollectionAdapter extends RecyclerView.Adapter<CollectionFragment.MyCollectionAdapter.ViewHolder>
    {
        ...
        @NonNull
        @Override
        public CollectionFragment.MyCollectionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v= LayoutInflater.from(getActivity()).inflate(R.layout.item,parent, false);
            return new CollectionFragment.MyCollectionAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull CollectionFragment.MyCollectionAdapter.ViewHolder holder, final int position) {
            //picture
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    navController.navigate(R.id.collectselectFragment,bundle);
