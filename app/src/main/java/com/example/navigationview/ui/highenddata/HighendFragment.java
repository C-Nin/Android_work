package com.example.navigationview.ui.highenddata;
...
public class HighendFragment extends Fragment {

    private HighendViewModel mViewModel;
    RecyclerView recyclerView;
    private HighendFragment.MyHighendAdapter adapter;

    private List<HashMap<String, Object>> list = new ArrayList<HashMap<String, Object>>();
    private List<HashMap<String, Object>> mData = new ArrayList<HashMap<String, Object>>();

    public static HighendFragment newInstance() {
        return new HighendFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        adapter = new HighendFragment.MyHighendAdapter();
        recyclerView.setAdapter(adapter);
        return view;
    }
    private void getData(){
        String url=new MyApplication().selecthighendurl;
    ...
    class MyHighendAdapter extends RecyclerView.Adapter<HighendFragment.MyHighendAdapter.ViewHolder>{
        ...
        @NonNull
        @Override
        public HighendFragment.MyHighendAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v= LayoutInflater.from(getActivity()).inflate(R.layout.item,parent, false);
            return new HighendFragment.MyHighendAdapter.ViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull HighendFragment.MyHighendAdapter.ViewHolder holder, final int position) {
